...
import { q as g } from "./chunk-KXQY476L.js";
g();
g();
function D(r, t, n, s) {
...
var m = class extends _ {
  ...
  digestInto(t) {
    y(this), C(t, this), (this.finished = !0);
    ...
    process(t, n) {
      ...
      for (let c = 16; c < 64; c++) {
        let p = d[c - 15],
          l = d[c - 2],
          A = a(p, 7) ^ a(p, 18) ^ (p >>> 3),
          B = a(l, 17) ^ a(l, 19) ^ (l >>> 10);
        d[c] = (B + d[c - 7] + A + d[c - 16]) | 0;
      }
      let { A: s, B: i, C: o, D: e, E: h, F: f, G: x, H: b } = this;
      for (let c = 0; c < 64; c++) {
        let p = a(h, 6) ^ a(h, 11) ^ a(h, 25),
          l = (b + p + E(h, f, x) + G[c] + d[c]) | 0,
          B = ((a(s, 2) ^ a(s, 13) ^ a(s, 22)) + F(s, i, o)) | 0;
        (b = x),
          (x = f),
          (f = h),
          (h = (e + l) | 0),
